...
const ProjectSidebar = () => {
  ...
  // Reorder projects to put Shivalik Greenfield first
  const reorderedProjects = [...allProjects].sort((a, b) => {
    if (a.id === 'greenfield-shantigram') return -1;
    if (b.id === 'greenfield-shantigram') return 1;
    return 0;
  });
